  ...
  return (
    <div className="sm:w-72 w-screen hidden  fixed top-20 left-0 h-screen sm:sticky sm:top-10 px-5 sm:px-0 sm:left-10 z-10  sm:flex items-center justify-center pl-0 sm:pl-5 rounded-md  flex-col">
      ...
      >
        ...
        <div className="flex  flex-col text-left h-fit gap-5 text-white w-full  relative ">
      ...
      <div className="flex gap-2 bg-slate-600 py-5 border-1 border-slate-700 w-full justify-center mt-2 rounded-md px-2">
        {active ? (
          <button
            onClick={handelDetele}
            className={` bg-red-500 hover:bg-red-700 text-white font-bold py-2  px-2 text-sm rounded-md shadow-lg flex items-center gap-2`}
          >
        ...
        <button
          ...
          className=" text-white py-2  bg-blue-500 hover:bg-blue-700 font-bold  px-2 text-sm rounded-md shadow-lg flex items-center gap-2"
        >
