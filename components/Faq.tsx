        ...
        <CardContent className="p-6">
          ...
          <Accordion className="w-full mt-4" type="multiple">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                AgileMind is an innovative platform that leverages artificial
            ...
            <AccordionItem value="item-2">
              <AccordionTrigger className="hover:underline-none">
                How does AgileMind use AI to generate project ideas?
              </AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-3">
              <AccordionTrigger className="hover:underline-none">
                Can I collaborate with my team on AgileMind?
              </AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem value="item-4">
              <AccordionTrigger className="hover:underline-none">
                How does AgileMind protect my data?
              </AccordionTrigger>
              <AccordionContent>
            ...
            <AccordionItem className="border-b-0" value="item-5">
              ...
              <AccordionContent>
                ...
                us via email at support@[WebsiteName].com, or use the contact
                form on our website. We aim to respond to all inquiries within
                24 hours.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
